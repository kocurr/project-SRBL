        ...
        <table class="table table-bordered table-secondary">
          <thead class="thead-dark">
            ...
            <?php
              ...
              {
                echo "<tr><td>".$row->airplane_id."</td>";
                echo "<td>".$row->producer."</td>";
                echo "<td>".$row->type."</td>";
                echo "<td><a href='update_airplane?id=".$row->airplane_id."'><button type='submit' align='center' class='submit btn btn-outline-primary'>Edytuj</button>&nbsp&nbsp</a>";
                echo "<a href='delete_airplane?id=".$row->airplane_id."'><button type='submit' align='center' class='submit btn btn-outline-danger'>Usuń samolot</button></a></td></tr>";
              }
            ?>
        </table><br><br><br><br>
      </div>
