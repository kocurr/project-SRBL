  ...
  <body style="font-family: 'Montserrat';font-size: 20px;">
      ...
      <div class="row container-fluid">
        <div class="col" style="text-align: center; padding-top: 20px">
          <h1>Zalogowano jako ADMIN</h1><br><br>
          <h3>Wybierz czynność:</h3>
          <li><a href="<?= base_url();?>main/flights_admin">Przeglądaj loty&nbsp&nbsp</a></li>
          <li><a href="<?= base_url();?>main/airplanes_admin">Przeglądaj samoloty&nbsp&nbsp</a></li>
					<li><a href="<?= base_url();?>user/add_admin">Dodaj nowe&nbsp&nbsp</a></li>
					<li><a href="<?= base_url();?>testing">Testy&nbsp&nbsp</a></li>
        </div>
      </div><br><br>
